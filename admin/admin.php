...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <?php
			...
			?>
		<title>Admin Panel--<?php echo $login_session; ?></title>
            ...
            <div id="header-main">
                <div class="container_12">
                    <div class="grid_12">
                        <div id="logo">
                            <ul id="nav">
                                <li id="current" title="View Your Dashboad"><a href="admin.php">Dashboard</a></li> 
...
?>                      
            ...
            <div class="grid_12">
                ...
                <!-- Example table -->
                <div class="module">
                	<h2><span>New Founds Queries</span></h2>
                        ...
                        <table id="myTable" class="tablesorter">
                        	<thead>
                                <tr>                               
                                    ...
                                    <th style="width:21%">Found From</th>
                                    <th style="width:18%">Person Name</th>
                            ...
                            <tbody>
                                ...
                                <?php
									...
									{												
								?>
                                	<td class="align-center"><?php echo $row['FoundID']; ?></td>
                                    <td><a href=""><?php echo $row['ProductName']; ?></a></td>
                                    <td><?php echo $row['Category']; ?></a></td>
                                    <td><?php echo $row['FoundFrom']; ?></td>
                                    <td><?php echo $row['PersonName']; ?></td>
                                    <td><?php echo $row['ContactNumber']; ?></td>
                                    
                                    <td>
                                    	<input type="checkbox" />
                                        <a href="deletemessages.php?deletefound=<?php echo $row['FoundID']; ?>"> <img src="images/minus-circle.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/minus-circle.gif" width="16" height="16" alt="not published" title="Delete" /></a>    
                                    </td>
           ...
           <div class="grid_12">
                ...
                <!-- Example table -->
                <div class="module">
                	<h2><span>New Lost Queries</span></h2>
                        ...
                        <table id="myTable" class="tablesorter">
                        	<thead>
                                <tr>
                                    ...
                                    <th style="width:15%">Product Name</th>
                                    <th style="width:10%">Category</th>
                                    <th style="width:21%">Lost From</th>
                                    <th style="width:18%">Person Name</th>
                                    <th style="width:13%">Contact</th>
                                    <th style="width:15%">Operations</th>
                                </tr>
                            ...
                            <tbody>
								...
								?>
                                	<td class="align-center"><?php echo $row['LostID']; ?></td>
                                    <td><a href=""><?php echo $row['ProductName']; ?></a></td>
                                    <td><?php echo $row['Category']; ?></a></td>
                                    <td><?php echo $row['LostFrom']; ?></td>
                                    <td><?php echo $row['PersonName']; ?></td>
                                    <td><?php echo $row['ContactNumber']; ?></td>
                                    
                                    <td>
                                    	<input type="checkbox" />
                                        <a href="deletemessages.php?deletelost= <?php echo $row['LostID']; ?> "> <img src="images/minus-circle.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/minus-circle.gif" width="16" height="16" alt="not published" title="Delete Relays" /></a>  
                                    </td>                                
                                    </tr>
                                    <?php
									}
