...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <?php
			...
			?>
		<title>Messages(<?php echo $count; ?>)</title>
            ...
            <div id="header-status">
                <div class="container_12">
                    ...
                    <div class="grid_4">
                        ...
                        <strong>Logout</strong><?php echo ' ('.$login_session.')'; ?>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="grid_12">
                        <div id="logo">
                            <ul id="nav">
                                ...
                                <li id="current"><a href="messages.php" title="You Might Have Some Messages">Messages
                                (<?php echo $count; ?>)</a></li>
...
<?php
    ...
    <p>
        ...
        <strong>Username </strong><?php echo $row['UserName']; ?><br />
...
?>                      
            ...
            <div class="grid_12">
  				...
  				<div class="bottom-spacing">
                    ...
                    Search Email: <input type="text" class="input-short" name="txtSearch" />
                    <input class="submit-green" type="submit" value="Search Mail" name="btnState" />
                    </form>
                        ...
                        <table id="myTable" class="tablesorter">
                        	<thead>
                                <tr>
                                    ...
                                    <th style="width:21%">Message Content</th>
                            ...
                            <tbody>
                                ...
                                <?php
									include('config.php');
									$query="select QueryID,PersonName,EmailAddress,Query,Subject,Date from querymaster";
									$result=mysqli_query($con,$query) or die(mysqli_error($con));
									while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
									{
								 ?>
                                    <td class="align-center"><?php echo $row['QueryID']; ?></td>
                                    <td><a href=""><?php echo $row['PersonName']; ?></a></td>
                                    ...
                                    <td>
                                    	...
                                    	<input type="checkbox" />
                                        <a href="deletemessages.php?deletemessages=<?php echo $row['QueryID']; ?>"><img src="images/minus-circle.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/minus-circle.gif" width="16" height="16" alt="not published" title="Delete Message" /></a>  
                                        <a href="replayquery.php?replay=<?php echo $row['QueryID']; ?>"><img src="images/arrow-curve-000-left.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/minus-circle.gif" width="16" height="16" 
                                        alt="not published" title="Replay to the Message"  />
                                        </a>    
                                    </td>
                                    </tr>
                                    <?php
                ...
                <div class="module">
                	<h2><span>Replayed Messages</span></h2>
                    ...
                    <div class="module-table-body">
                        ...
                        <table id="myTable" class="tablesorter">
                            ...
                            <tbody>
                                ...
                                <?php
									include('config.php');
									$query="select ReplayID,MessageTo,MessageFrom,Message from replaymaster";
									$result=mysqli_query($con,$query) or die(mysqli_error($con));
									while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
									{
								 ?>
                                    <td class="align-center"><?php echo $row['ReplayID']; ?></td>
                                    <td><a href=""><?php echo $row['MessageTo']; ?></a></td>
                                    ...
                                    <td>
                                    	...
                                    	<input type="checkbox" />
                                        <a href="deletemessages.php?deletereplay=<?php echo $row['ReplayID']; ?>"> <img src="images/minus-circle.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/minus-circle.gif" width="16" height="16" alt="not published" title="Delete Relays" /></a>  
        ...
        <div id="footer">
        	<div class="container_12">
            	<div class="grid_12">
                	...
                	<p>&copy; 2023. <a href="#" title="Visit to official Profile">IIT Jodhpur</a> and <a href="#" title="Visit to official Profile">Department of CSE</a>	</p>
        		</div>
            </div>
            <div style="clear:both;"></div>
        </div> <!-- End #footer -->
