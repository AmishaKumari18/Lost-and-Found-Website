    ...
    <div class="container_12">
        ...
        <div class="module">
            ...
            <div class="module-body">
                ...
                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                    ?>
                    <a href="deletemessages.php?cat=<?php echo $row['CategoryID']; ?>" class="removable"
                        id="<?php echo $row['CategoryID']; ?>"><?php echo $row['CategoryName']; ?></a><br />
                <?php
                }
                ?>
                ...
                <form action="addcategory.php" method="post">
                    <fieldset>
                        <input type="text" required="required" class="input-medium"
                            name="txtCategory" />&nbsp;&nbsp;<input class="submit-green" type="submit"
                            value="Add category" />
                    </fieldset>
                </form>
            </div>
                    ...
                    <fieldset>
                        <table>
                            <tr>
                                ...
                                <td><input type="text" class="input-medium" name="txtCountryName" required="required" />
                                </td>
                            </tr>
                            <tr>
                                <td>Country Code</td>
                                <td><input type="text" class="input-medium" name="txtCountryCode" required="required" />
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><input class="submit-green" type="submit" value="Add Country" name="txtCountry" />
                                </td>
                            </tr>
                ...
                <form action="addCSC.php" method="post">
                    <table>
                        <tr>
                            ...
                            <td style="width:100%"><select class="pagesize input-short align-left" name="opnCountry">
                                    <?php
                                    include('config.php');
                                    $query = "select *from countrymaster Order by CountryName ASC";
                                    $result = mysqli_query($con, $query);
                        ...
                        <tr>
                            ...
                            <td style="width:100%"><select class="pagesize input-short align-left" name="opnState">
                                    <?php
                                    include('config.php');
                    ...
                    <fieldset>
                        <input type="text" required="required" class="input-medium" name="txtCity" />&nbsp;&nbsp;<input
                            class="submit-green" type="submit" value="Add City" />
                    </fieldset>
                </form>
            </div>
        </div> <!-- module -->
    ...
    <div id="footer">
        <div class="container_12">
            <div class="grid_12">
                ...
                <p>&copy; 2023. <a href="#" title="Visit to official Profile">IIT Jodhpur</a> and <a href="#"
                        title="Visit to official Profile">Department of CSE</a> </p>
            </div>
        </div>
        <div style="clear:both;"></div>
    </div> <!-- End #footer -->
