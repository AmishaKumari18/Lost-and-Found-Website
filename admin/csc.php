                ...
                <div class="grid_12">
                    <div id="logo">
                        <ul id="nav">
                            ...
                            <li id="current"><a href="csc.php"
                                    title="View Remove or Edit Cities, States and Countries">City State Country</a></li>
                        </ul>
                    </div><!-- End. #Logo -->
                </div><!-- End. .grid_12-->
                <div style="clear: both;"></div>
    ...
    <div class="container_12">
        ...
        <div class="grid_12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                        ...
                                        <td>
                                            <input type="checkbox" />
                                            <a href="deletemessages.php?deletecountry=<?php echo $row['CountryID']; ?>">
                                                <img src="images/minus-circle.gif"
                                                    tppabs="http://www.xooom.pl/work/magicadmin/images/minus-circle.gif"
                                                    width="16" height="16" alt="not published" title="Delete" /></a>
                                        </td>
            ...
            <div class="pagination">
                <a href="" class="button"><span><img src="images/arrow-stop-180-small.gif"
                            tppabs="http://www.xooom.pl/work/magicadmin/images/arrow-stop-180-small.gif" height="9"
                            width="12" alt="First" /> First</span></a>
                <a href="" class="button"><span><img src="images/arrow-180-small.gif"
                            tppabs="http://www.xooom.pl/work/magicadmin/images/arrow-180-small.gif" height="9"
                            width="12" alt="Previous" /> Prev</span></a>
                <div class="numbers">
                    <span>Page:</span>
                ...
                <a href="" class="button"><span>Next <img src="images/arrow-000-small.gif"
                            tppabs="http://www.xooom.pl/work/magicadmin/images/arrow-000-small.gif" height="9"
                            width="12" alt="Next" /></span></a>
                <a href="" class="button last"><span>Last <img src="images/arrow-stop-000-small.gif"
                            tppabs="http://www.xooom.pl/work/magicadmin/images/arrow-stop-000-small.gif" height="9"
                            width="12" alt="Last" /></span></a>
                <div style="clear: both;"></div>
            </div>
        </div> <!-- End .grid_12 -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                        ...
                                        <td>
                                            <input type="checkbox" />
                                            <a href="deletemessages.php?deletestate=<?php echo $row['StateID']; ?>"> <img
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                        ...
                                        <td>
                                            <input type="checkbox" />
                                            <a href="deletemessages.php?deletecity=<?php echo $row['CityID']; ?>"> <img
                                                    src="images/minus-circle.gif"
                                                    tppabs="http://www.xooom.pl/work/magicadmin/images/minus-circle.gif"
                                                    width="16" height="16" alt="not published" title="Delete" /></a>
                                        </td>
                ...
                <div id="footer">
                    <div class="container_12">
                        <div class="grid_12">
                            ...
                            <p>&copy; 2023. <a href="#" title="Visit to official Profile">IIT Jodhpur</a> and <a
                                    href="#" title="Visit to official Profile">Department of CSE</a> </p>
                        </div>
                    </div>
                    <div style="clear:both;"></div>
                </div> <!-- End #footer -->
