                ...
                <div class="module-body">
                    <form action="addFound.php" method="post" enctype="multipart/form-data">
                        <table>
                            ...
                            <tr>
                                <td>Image</td>
                                <td><input type="file" name="txtFoundImage" required="required" />
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" class="input-medium" name="txtFoundFrom" required="required" />
                                </td>
                            </tr>
                            <tr>
                                <td>Person Name</td>
                        ...
                        <fieldset>
                            ...
                            &nbsp;&nbsp;<input class="submit-green" type="submit" value="Add Item" name="btnFoundItem"
                                required="required" />
                        </fieldset>
                    </form>
                </div>
