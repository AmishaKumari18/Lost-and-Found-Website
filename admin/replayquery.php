                         ...
                         <form action="sendmail.php" method="post">
                                ...
                                <?php 
									...
									if(isset($_GET['replay']))
									{
											...
											$query="select *from querymaster where QueryID='{$replay}'";
											$result=mysqli_query($con,$query) or die(mysqli_error($con));
								...
								?>
                                	<td>To</td>
                                    <td><input type="text" value="<?php echo $row['EmailAddress']; ?>"  class="input-medium" name="txtTo" required="required"  /></td>
                                </tr>
                                <tr>
                                	<td>From</td>
                                    <td><input type="text" class="input-medium" name="txtFrom" required="required"  value="Admin" /></td>
                                </tr>
								<tr>
                                	<td>Message</td>
                                    <td><textarea cols="40" rows="10" name="txtMessage" required="required"></textarea></td>
                                </tr>
                               <tr><td></td>
                               <td align="right">
                               	<fieldset>
                            
                                <input class="submit-green" type="submit" value="Send" name="btnSend" />
                            </fieldset>
                               </td>
                               </tr>
                               <?php
