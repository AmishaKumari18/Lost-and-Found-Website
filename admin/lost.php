...
<body>
                ...
                <div class="grid_12">
                    <div id="logo">
                        <ul id="nav">
                            ...
                            <li id="current"><a href="lost.php" title="Lost Something?">Lost</a></li>
    ...
    <div class="container_12">
        ...
        <div class="grid_6">
            ...
            <div class="module">
                <h2><span>Lost Query</span></h2>

                <div class="module-body">
                    <form action="addLost.php" method="post" enctype="multipart/form-data">
                        <table>
                            <tr>
                                <td>Product Name</td>
                                <td><input type="text" class="input-medium" name="txtProductName" required="required" />
                                </td>
                            </tr>
                            <tr>
                                <td>Category</td>
                            ...
                            <tr>
                                <td>Image</td>
                                <td><input type="file" name="LostImage" required="required" /> </td>
                            </tr>
                            <tr>
                                <td>Lost From</td>
                                <td><input type="text" class="input-medium" name="txtLostFrom" required="required" />
                                </td>
                            </tr>
                            <tr>
                                <td>Person Name</td>
                                <td><input type="text" class="input-medium" name="txtPersonName" required="required" />
                                </td>
                            </tr>
                            <tr>
                                <td>Contact</td>
                                <td><input type="text" class="input-medium" name="txtMobileNumber"
                                        required="required" /></td>
                            </tr>
                            <tr>
                                <td>Email Address</td>
                                <td><input type="text" class="input-medium" name="txtEmailAddress"
                                        required="required" /></td>
                            </tr>
                        </table>
                        ...
                        <fieldset>
                            ...
                            &nbsp;&nbsp;<input class="submit-green" type="submit" value="Add Item" name="btnAddItem" />
                        </fieldset>
                    </form>
                </div>
            </div> <!-- module -->
