	...
	<div class="wrap">
		<div class="header">
			<div class="headertop_desc">
				<div class="call">
					<img class="iitj-logo" src="images/logo_iitj.png" style="height : 60px ; width : 80px">

				</div>
				<div class="account_desc">
					<ul>
						<li><a style="color: #9C9C9C;" onmouseover="this.style.color='white';"
								onmouseout="this.style.color='#9C9C9C';" href="home.php">Help</a></li>
						<li><a style="color: #9C9C9C;" onmouseover="this.style.color='white';"
					...
					<div class="categories">
						<ul>
							...
							while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
								...
								<li><a href="$row['CategoryID'].php" ?cat=<?php echo $row['CategoryID']; ?>"><?php echo $row['CategoryName']; ?></a></li>
				...
				<div class="header_bottom_right">
					<div class="slider">
						...
						<div class="row">
							...
							<div class="col-sm-9">
								<h3 style="font-size:30px">Chat</h3>
								<p style="font-size:20px ; color : #888888">
									Chat portal on the website allows users to communicate with each other in real-time through 
									a mkessaging interface provided by website.
								</p>
							</div>
						</div>
					</div> -->
